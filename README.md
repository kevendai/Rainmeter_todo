...
- 主程序仅捆绑 arXiv 与 Calendar-to-Todo；“SSDP 服务器 IP”作为标注为私人插件的市场可选项，不随主程序捆绑。
...
为兼容 v1.3.5 的旧版 full/lite 升级器，v2.0.0 及后续版本的 full 和 lite 引导 zip 会先安装 v1.4.4。第一次更新结束后请再次点击“检查更新”，再由 v1.4.4 的统一更新器校验 SHA256 并安装当前最新版；full 和 lite 不再代表不同功能。
